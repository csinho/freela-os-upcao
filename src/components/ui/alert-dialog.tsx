...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-[100] grid w-[calc(100%-1.5rem)] max-w-[calc(100%-1.5rem)] gap-3 border bg-background p-4 shadow-lg duration-200",
        "left-1/2 top-auto bottom-[max(1rem,env(safe-area-inset-bottom))] -translate-x-1/2 translate-y-0 rounded-2xl",
        "max-h-[min(70dvh,100vh-2rem)] overflow-y-auto",
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        "data-[state=closed]:slide-out-to-bottom-4 data-[state=open]:slide-in-from-bottom-4",
        "sm:bottom-auto sm:top-[50%] sm:w-full sm:max-w-md sm:translate-y-[-50%] sm:gap-4 sm:p-6 sm:rounded-lg",
